/*
]=====> ANDYKING <=====[ ]=====> YT Ramlan ID <=====[ ]=====> 088238145094 <=====[
*/
...
const { simple } = require('./database/simple')
const { gabut } = require('./database/gabut')
const { groupm } = require('./database/group')
const { download } = require('./database/download')
const { dompet } = require('./database/dompet')
const { random } = require('./database/random')
const { other } = require('./database/other')
const { owb } = require('./database/owb')
const { maker } = require('./database/maker')
const { sound } = require('./database/sound')
